...
\renewcommand{\chapter}[1]{\cbend \oldchapter{#1} \label{chapter: #1}}

\NewCommandCopy{\oldsection}{\section}
\renewcommand{\section}[1]{\cbend \oldsection{#1} \label{section: #1} \cbstart}

\NewCommandCopy{\oldsubsection}{\subsection}
\renewcommand{\subsection}[1]{\cbend \oldsubsection{#1} \label{subsection: #1}\cbstart}

\NewCommandCopy{\oldsubsubsection}{\subsubsection}
\renewcommand{\subsubsection}[1]{\cbend \oldsubsubsection{#1} \label{subsubsection: #1}\cbstart}
