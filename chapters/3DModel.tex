...
\subsection{Rest}
The \appcommand{Plastic Part \then Rest} tool is very similar to the Emboss feature in 3D modelling. It allows us to create a flat "landing area" on a curved surface, which is useful because we can the create new planes and components on this area.
