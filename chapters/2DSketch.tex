...
\item Project to 3D Sketch: Used to project your 2D sketch onto a 3D surface. For more information on this group of features, see "3D Sketches" or \appcommand{3D Model \textgreater Surface}.
...
All constraints can be viewed by right clicking on the workspace and selecting \appcommand{Show All Constraints} or using the F8 hotkey. Constraints can be hidden by right clicking on the workspace and selecting \appcommand{Hide All Constraints} or using the F9 hotkey.
